  ...
  <section class="clearfix">
    ...
    <article>
      <figure class="pull-sm-left">
        <img src="img/director_small.jpg" alt="Marc Hess directeur de Esgis Immo" class="img-fluid hidden-sm-up m-b-1">
        <img src="img/director_medium.jpg" alt="Marc Hess directeur de Esgis Immo" class="img-fluid hidden-xs-down hidden-lg-up m-r-1 m-b-1">
        <img src="img/director_large.jpg" alt="Marc Hess directeur de Esgis Immo" class="img-fluid hidden-md-down m-r-1 m-b-1">
...
<!-- Second section with the values of the agency -->
    ...
    <article>
      <figure class="pull-sm-right">
        <img src="img/family_small.jpg" alt="Marc Hess directeur de Esgis Immo" class="img-fluid hidden-sm-up m-b-1">
        <img src="img/family_medium.jpg" alt="Marc Hess directeur de Esgis Immo" class="img-fluid hidden-xs-down hidden-lg-up m-l-1 m-b-1">
        <img src="img/family_large.jpg" alt="Marc Hess directeur de Esgis Immo" class="img-fluid hidden-md-down m-l-1 m-b-1">
      </figure>
