  ...
  <div class="container">
    <div class="row">
      ...
      <figure class="col-xs-5">
        ...
        <img src="img/logo_immo_medium.jpg" alt="logo Esgis Immo" class="img-fluid hidden-xs-down hidden-lg-up">
        <img src="img/logo_immo_small.jpg" alt="logo Esgis Immo" class="img-fluid hidden-sm-up">
      </figure>
  ...
  <div class="collapse navbar-toggleable-xs" id="exCollapsingNavbar2">
    <ul class="nav navbar-nav">
      ...
      <li class="nav-item m-x-1">
        <a class="nav-link" href="{{ URL::to('/achat') }}">Achat</a>
      </li>
      <li class="nav-item m-x-1">
        <a class="nav-link" href="{{ url::to('/location') }}">Location</a>
      </li>
      <li class="nav-item m-x-1">
        <a class="nav-link" href="{{ url::to('/presentation') }}">Présentation</a>
      </li>
      <li class="nav-item m-x-1">
        <a class="nav-link" href="{{ url::to('/agences') }}">Nos agences</a>
      </li>
    </ul>
  </div>
